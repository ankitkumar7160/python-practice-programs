...
12. Print numbers from **1 to n**.
13. Find the **sum of numbers from 1 to n**.
14. Print **multiplication table from 1 to 10**.
15. Print the **multiplication table of any number**.
16. Print **even numbers from 1 to 100**.
17. Print **odd numbers from 1 to 100**.
18. Find the **average of numbers from 1 to n**.
19. Print **reverse counting (10 to 1)**.
